...
#else
      printf(2, "(bytes_written) != (bytes_read) \n");
#endif
      return -1;
    }
  }
...
#else
  printf(1, "single process pipe test FAILED \n");
#endif
    }
    else {
#ifdef LINUX
...
#else
      printf(1, "single process pipe test PASSED \n");
#endif
    }
  }
...
#else
  printf(1, " multi process pipe test FAILED \n");
#endif
    }
    else {
#ifdef LINUX
...
#else
      printf(1, " multi process pipe test PASSED \n");
#endif
    }
  }
